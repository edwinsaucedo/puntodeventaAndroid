...
public class SimpleSpinnerUnitMeasurementAdapter extends BaseAdapter implements SpinnerAdapter {
    private Context context;
    private ArrayList<UnitMeasurementEntity> unitMeasurementList;

    public SimpleSpinnerUnitMeasurementAdapter(ArrayList<UnitMeasurementEntity> unitMeasurementList, Context context) {
        this.context = context;
        this.unitMeasurementList = unitMeasurementList;
    }

    public SimpleSpinnerUnitMeasurementAdapter(FragmentActivity activity, int spinner_provider, ArrayList<UnitMeasurementEntity> unitMeasurementList) {
    }
