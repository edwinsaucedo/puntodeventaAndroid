package com.example.administrador.pvsegalmex.print;
...
public class printer {
	...
	public int PrintStringEx(String str, int nHeight, boolean bUnderline,
	...
	public int PrintLineInit(int nHeight)
	{
		m_pat.setTextSize(nHeight);
	...
	public void PrintBitmapEx(final Bitmap bm) {

		int nheight = bm.getHeight() * 384 / bm.getWidth();
		int nwidth=bm.getWidth();
		Bitmap bmp = Bitmap.createBitmap(384, 108, Config.ARGB_4444);
		Canvas can1 = new Canvas(bmp);
		Paint paint = new Paint();
		paint.setColor(Color.WHITE);
		can1.drawRect(0, 0, 384, 108, paint);
		can1.drawBitmap(bm, new Rect(0, 0, bm.getWidth(), bm.getHeight()),
				new Rect((384-108)/2, 0, (384+108)/2, 108), paint);

		ShowLog(bmp);
		//TestPrintMainActivity.saveMyBitmap(bmp);
	}


	public void PrintBitmapExSpecial(final Bitmap bm, int nleft, int ntop, int nwidth, int nsrcheight) {

		int nheight =nsrcheight ;
		Bitmap bmp = Bitmap.createBitmap(nwidth, nheight, Config.ARGB_4444);
		Canvas can1 = new Canvas(bmp);
		Paint paint = new Paint();
		paint.setColor(Color.WHITE);
		can1.drawRect(0, 0, nwidth, nheight, paint);
		can1.drawBitmap(bm, new Rect(nleft, ntop, nwidth + nleft, nsrcheight + ntop),
				new Rect(nleft/2, ntop/2, nwidth+(nleft/2), nheight+(ntop/2)), paint);
