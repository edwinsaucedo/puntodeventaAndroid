...
import com.example.administrador.pvsegalmex.application.AppController;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public SyncAdapter(Context context, boolean autoInitialize) {
        ...
        AppController.getInstance().setSincronizacion(new Synchronization(context));
    }
    ...
    public void onPerformSync(Account arg0, Bundle arg1, String arg2,
        ...
        AppController.getInstance().getSynchronization().sync();
    }
}