...
public class CashShortApi {
    @SerializedName("code")
    @Expose
    private String code;
    @SerializedName("response")
    @Expose
    private ResponseCasShort response;
    ...
    public ResponseCasShort getResponse() {
        return response;
    }

    public void setResponse(ResponseCasShort response) {
        this.response = response;
    }

}

class ResponseCasShort{
