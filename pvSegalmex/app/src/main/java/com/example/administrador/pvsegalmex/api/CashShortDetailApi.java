...
public class CashShortDetailApi {
    @SerializedName("code")
    @Expose
    private String code;
    @SerializedName("response")
    @Expose
    private ResponseCasShortDetail response;
    ...
    public ResponseCasShortDetail getResponse() {
        return response;
    }

    public void setResponse(ResponseCasShortDetail response) {
        this.response = response;
    }

}

class ResponseCasShortDetail{
