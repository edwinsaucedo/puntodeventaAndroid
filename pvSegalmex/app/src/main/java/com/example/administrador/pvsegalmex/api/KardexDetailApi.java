...
public class KardexDetailApi {
    @SerializedName("code")
    @Expose
    private String code;
    @SerializedName("response")
    @Expose
    private ResponseKardexDetail response;
    ...
    public ResponseKardexDetail getResponse() {
        return response;
    }

    public void setResponse(ResponseKardexDetail response) {
        this.response = response;
    }

}

class ResponseKardexDetail{
