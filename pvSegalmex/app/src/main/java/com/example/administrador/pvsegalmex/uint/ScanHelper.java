...
public class ScanHelper {
	...
	public static final String SCAN_MODELS_SETTINGS = "scan_models_settings";
	...
	public static int getScanMode(Context context){
		return Settings.System.getInt(context.getContentResolver(), SCAN_MODELS_SETTINGS, 0);
	}
	 ...
	 */
	public static void setScanMode(Context context, int state){
		Settings.System.putInt(context.getContentResolver(), SCAN_MODELS_SETTINGS, state);
	}
	 ...
	 */
	public static int getBarcodeReceiveMode(Context context){
	 ...
	 */
	public static void setBarcodeReceiveMode(Context context, int state){
	 ...
	 * @param flag
	 */
	public static void setScanVibration(Context context, boolean flag){
